...
const cardsSchema = Yup.object().shape({
  ...
  groupDescription: Yup.string().max(300, "Group Description Must be less than 300 characters").min(20, "Group Name Must be More Than 20 Characters").required('Group description is required'),
  cards: Yup.array().of(
    Yup.object().shape({
