...
const Card = ({ group }) => {
  ...
  return (
    <div className="p-2 flex flex-col space-y-3 items-center justify-center rounded-lg w-[25rem] h-[18rem] relative border-2 border-gray-200 bg-white">
      <div className="absolute -top-8">
        <img
          className="rounded-full w-16 h-16 object-cover aspect-square"
          src={demoimage}
          alt={group.groupName} // Use the group name as alt text for the image
        />
      </div>
      <div className="m-1 absolute top-0 right-0">
